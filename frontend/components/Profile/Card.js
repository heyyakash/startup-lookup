...
const Card = ({ name, type, id, value }) => {
    return (
        <div>
            <div className="max-w-sm scale-90 hover:scale-[1] transitionall  font-prosans relative w-[300px] bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                ...
                <div className="p-5">
                    ...
                    <Link href={`/main/dashboard/${name}`} >
                            <div className=' transitionall cursor-pointer bg-white mt-4 py-2 px-6 dark-shadows rounded-xl'>
                            View
                            </div>
                        </Link>
                </div>
