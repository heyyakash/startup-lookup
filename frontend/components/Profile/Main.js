...
const Main = ({ user, data }) => {
  return (
    <div className='p-5 lg:flex-[1] w-[100%] overflow-auto'>
      <div className='w-full rounded-xl bg-green-400 dark-shadows p-4'>
        <h2 className='text-2xl transitionall font-bold font-prosansbold'>Good Afternoon, {user?.payload?.firstname}.</h2>
